...
"[project]/app/api/admin/cdc-delete/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(request) {
    try {
        ...
        const { error, count } = await queryClient.from('donations').delete({
            count: 'exact'
        }).eq('id', id).eq('is_cdc_asset', true);
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b09576fd._.js.map