...
"[project]/app/api/update-points/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { data: userData, error: userError } = await supabase.from('users').select('eco_points').eq('id', user.id).single();
        if (userError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__335166ad._.js.map