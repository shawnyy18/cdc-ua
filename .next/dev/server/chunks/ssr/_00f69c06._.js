module.exports = [
"[project]/lib/commentService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handleCommentSubmit(postId, commentText) {
    ...
    try {
        // Get current user
        const { data: userData, error: userErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
        if (userErr) {
        ...
        const { data: inserted, error: insertErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('post_comments').insert({
            post_id: postId,
            user_id: user.id,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$commentService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/commentService.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function CommunityFeed() {
        ...
        async function load() {
            ...
            try {
                ...
                if (!rpcError && Array.isArray(rpcPosts)) {
                    if (mounted) setPosts(rpcPosts.map((fp)=>({
                            id: fp.id,
                            content: fp.content,
    ...
    async function toggleLike(postId) {
        ...
        try {
            ...
            try {
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].rpc('toggle_like', {
    ...
    async function submitComment(postId) {
        ...
        if (!text) return;
        const inserted = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$commentService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleCommentSubmit"])(postId, text);
        if (inserted) {
                    ...
                    children: [
                        ...
                        commentsOpen[post.id] && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: commentsLoading[post.id] ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                className: "space-y-2",
                                children: [
                                    (commentsByPost[post.id] || []).map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_00f69c06._.js.map