...
function ResetPasswordPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ResetPasswordPage.useEffect": ()=>{
            ...
            const checkRecoverySession = {
                "ResetPasswordPage.useEffect.checkRecoverySession": async ()=>{
                    try {
            ...
            }["ResetPasswordPage.useEffect.checkRecoverySession"];
    ...
    const handlePasswordReset = async (e)=>{
        ...
        setIsLoading(true);
        try {
            const { error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.updateUser({
                password
            });
            if (updateError) {
...
_s(ResetPasswordPage, "Vq0EtSXgYMdstt3/Q9PLfVsHO3c=", false, function() {
    return [
...
//# sourceMappingURL=app_reset-password_page_tsx_2c91bdd4._.js.map